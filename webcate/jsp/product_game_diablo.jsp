...
<link href="css/product_game_diablo.css" rel="stylesheet"
	type="text/css">
...
<body>
	...
	<main>
		<div class="introductionGame">
			<img src="./img/diablo1.jpg" width="1280" height="720">
			<h3>
				<font color="red">アクションロールプレイングゲームDiablo4</font>
			</h3>
			<div class="performanceGame">
				<div class="performancePC">
					...
					for(Assembly ad : adlist){
						...
						if (ad.getAssembly_price() >= 200000) {
					%>
