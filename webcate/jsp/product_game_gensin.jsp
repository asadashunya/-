...
<link href="css/product_game_gensin.css" rel="stylesheet"
	type="text/css">
...
<body>
	...
	<main>
		<div class="introductionGame">
			<img src="./img/gensin1.jpg" width="1280" height="720">
			<div class="performanceGame">
				<div class="performancePC">
					...
					for(Assembly ad : adlist){
						...
						if (ad.getAssembly_price() >= 160000) {
					%>
					...
					for(Assembly ad : adlist){
						...
						if (ad.getAssembly_price() >= 220000) {
					%>
