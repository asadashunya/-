 ...
 */
@WebServlet("/Product_game_apexlegends")
public class Product_game_apexlegends extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ad.connectionClose();
		 ...
		 //forward する 
		 RequestDispatcher rd = request.getRequestDispatcher("product_game_apexlegends.jsp"); 
