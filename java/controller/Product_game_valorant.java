 ...
 */
@WebServlet("/Product_game_valorant")
public class Product_game_valorant extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ad.connectionClose();
		 ...
		 //forward する 
		 RequestDispatcher rd = request.getRequestDispatcher("product_game_valorant.jsp"); 
