 ...
 */
@WebServlet("/Product_game_overwatch")
public class Product_game_overwatch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ad.connectionClose();
		 ...
		 //forward する 
		 RequestDispatcher rd = request.getRequestDispatcher("product_game_overwatch.jsp"); 
