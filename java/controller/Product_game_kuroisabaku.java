 ...
 */
@WebServlet("/Product_game_kuroisabaku")
public class Product_game_kuroisabaku extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ad.connectionClose();
		 ...
		 //forward する 
		 RequestDispatcher rd = request.getRequestDispatcher("product_game_kuroisabaku.jsp"); 
